...
for hrs in range(regulators[0].total_timesteps):
    for reg in range(len(regulators)):
...
#Print Loss
print('System Losses/n')
print(regulators[0].system_losses)
print('Line Losses/n')
print(regulators[0].line_losses)
print('Transformer Losses/n')
print(regulators[0].transformer_losses)
